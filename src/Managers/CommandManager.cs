...
{
    private const string listCommand = "/arteklist";
    private const string settingsCommand = "/artekconfig";
    private const string editorCommand = "/artekeditor";
    private const string dutyInfoCommand = "/artekinfo";
